...
\
            ...
            .then(data => \{\
                ...
                if (bal > 0) \{\
                    currentBonus = bal;\
                    resultText.innerHTML = 'Balance: <span style="color:green">' + bal + ' \uc0\u8376 </span>';\
...
\
        priceElement.innerText = newTotal.toLocaleString('ru-RU') + ' \uc0\u8376 ';\
\
...
\
        if (realDiscount > 0) \{\
            ...
            \}\
            bonusTag.innerText = 'Discount: -' + realDiscount + ' \uc0\u8376 ';\
        \} else \{\
